# ⚙️ Repeated Arithmetic Machine - V2
...
- 🎚️Corrects the 2's complement output without any manual intervention. 
...
5. **📘Optional: Compare with Previous Versions** 
   - You can open [r_a_mv1.circ](../RAM_V1) to see manual B > A handling. 
