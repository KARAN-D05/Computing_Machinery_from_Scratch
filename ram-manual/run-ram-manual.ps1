Write-Host "+--------------------------------------------------+"
Write-Host "|       ram-manual - PowerShell Installer          |"
Write-Host "+--------------------------------------------------+"
...
Write-Host ""
Write-Host "Downloading ram-manual.c from GitHub..."
try {
    Invoke-WebRequest `
        -Uri "https://raw.githubusercontent.com/KARAN-D05/Computing_Machinery_from_Scratch/main/ram-manual/ram-manual.c" `
        -OutFile "ram-manual.c" `
        -ErrorAction Stop
...
Write-Host ""
Write-Host "Launching ram-manual..."
Write-Host "+--------------------------------------------------+"
Write-Host ""
.\ram-manual.exe
