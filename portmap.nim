...
# =============================================================================
# NEW: Extract ALL valid port names from tokens
#
# WHY:
# Old logic assumed → 1 line = 1 port ❌
# Real Verilog → 1 line can contain multiple ports:
#   input a, b, c
#
# HOW:
# - Clean punctuation (",", ");", etc.)
# - Ignore width tokens [7:0]
# - Ignore type keywords
...
proc parsePorts(filePath: string): seq[Port] =
  ...
  for rawLine in lines:
    ...
    #
    # WHY:
    # Default split(" ") fails for:
    #   a,b,c
    #
    # FIX:
    # Replace commas with spaced commas → then split
    # =============================================================================
    var tokens = line
      .replace(",", " , ")
      .splitWhitespace()
    ...
    # =============================================================================
    # NEW: Handle multiple ports per line
    # =============================================================================
