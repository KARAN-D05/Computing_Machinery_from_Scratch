...
proc renderMarkdown(ports: seq[Port], filePath: string) =
  ...
  echo ""
  echo "> *Generated by [portmap](https://github.com/KARAN-D05/Computing_Machinery_from_Scratch/blob/main/portmap.nim) - Nim port extractor*"
  echo ""
  echo "> *Precompiled Binary Release [Portmap-linux-x64](https://github.com/KARAN-D05/Computing_Machinery_from_Scratch/releases/tag/v1.0.0)**"
  echo ""
