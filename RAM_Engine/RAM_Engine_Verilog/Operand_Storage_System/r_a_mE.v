...
//
// Outputs:
//   d_ff1     [3:0] - Register slot 1, holds operand when sel = 0
//   d_ff2     [3:0] - Register slot 2, holds operand when sel = 1
//
// Behavior:
...
always @(posedge store_clk or posedge reset) begin
    ...
    // This ensures a known clean state on power-up or system reset.
    if (reset) begin
